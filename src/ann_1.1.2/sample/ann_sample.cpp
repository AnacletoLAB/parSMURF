...
thread_local int		k		= 1;			// number of nearest neighbors
thread_local int		dim		= 2;			// dimension
thread_local double		eps		= 0;			// error bound
thread_local int		maxPts	= 1000;			// maximum number of data points

thread_local istream*	dataIn	= NULL;			// input for data points
thread_local istream*	queryIn	= NULL;			// input for query points
