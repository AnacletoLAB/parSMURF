...
class DLL_API ANNsampStat {
	...
	double			minVal = ANN_DBL_MAX;	// min and max
	double			maxVal = -ANN_DBL_MAX;
public :
	...
	constexpr ANNsampStat() { /*reset();*/ }		// constructor
...
thread_local extern int			ann_Ndata_pts;	// number of data points
thread_local extern int			ann_Nvisit_lfs;	// number of leaf nodes visited
thread_local extern int			ann_Nvisit_spl;	// number of splitting nodes visited
thread_local extern int			ann_Nvisit_shr;	// number of shrinking nodes visited
thread_local extern int			ann_Nvisit_pts;	// visited points for one query
thread_local extern int			ann_Ncoord_hts;	// coordinate hits for one query
thread_local extern int			ann_Nfloat_ops;	// floating ops for one query
thread_local extern ANNsampStat	ann_visit_lfs;	// stats on leaf nodes visits
thread_local extern ANNsampStat	ann_visit_spl;	// stats on splitting nodes visits
thread_local extern ANNsampStat	ann_visit_shr;	// stats on shrinking nodes visits
thread_local extern ANNsampStat	ann_visit_nds;	// stats on total nodes visits
thread_local extern ANNsampStat	ann_visit_pts;	// stats on points visited
thread_local extern ANNsampStat	ann_coord_hts;	// stats on coordinate hits
thread_local extern ANNsampStat	ann_float_ops;	// stats on floating ops
//----------------------------------------------------------------------
//  The following need to be part of the public interface, because
//  they are accessed outside the DLL in ann_test.cpp.
//----------------------------------------------------------------------
DLL_API thread_local extern ANNsampStat ann_average_err;	// average error
DLL_API thread_local extern ANNsampStat ann_rank_err;	// rank error
